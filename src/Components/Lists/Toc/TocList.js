                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell key={`date-${row._id}`} align={props.align || 'center'}>
                                        <Box sx={{ padding: '0 25%' }}> {
                                                row.poster !== undefined ? <ImgNextGen
                                                    srcWebp={`/${location}/${posterName}/500/${posterName}.webp`}
                                                    srcJpeg={`/${location}/${posterName}/500/${posterName}.jpeg`}
                                                    fallback={`/${location}/${posterName}/500/${posterName}.png`}
