                ...
                <TableBody>
                    {stableSort(props.data, getComparator(order, orderBy))
                        ...
                        .map((row, index) => {
                            ...
                            const payments = paymentArray.filter((payment) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell key={`${row._id}date`} align={props.align || 'center'}>{`${date === "Invalid Date" ? 'N/A' : date.toLocaleDateString('en-us', { year: 'numeric', month: 'short', day: 'numeric' }) }`}</TableCell>
                                    <TableCell key={`${row._id}tournament`} align={props.align || 'center'}>{`${row.tournament.location.diamond}, ${row.tournament.location.city} (${row.tournament.dateTime ? new Date(row.tournament.dateTime.start.date).toLocaleDateString('en-us', { year: 'numeric', month: 'long', day: 'numeric' }) : 'N/A'})`}</TableCell>
