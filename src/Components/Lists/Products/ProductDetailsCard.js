...
import StockCard from "../../Lists/Stock/StockCard";
...
const ProductDetailCard = (props) => {
    ...
    useEffect(() => {
        ...
        const newStock = stockArray.filter((item) => {
            return item.ItemID === props.product._id;
        });
        setStock(newStock);
    }, [stockArray]);
    ...
    const saveNew = () => {
        ...
        Axios.put('/api/dashboard/products', {
            product: {
                assets: {
                    Image: images[0],
                    gallery: images
    ...
    const update = () => {
        Axios.put(`/api/dashboard/products/${props.product._id}`, {
            product: {
                assets: {
                    Image: images[0],
                    gallery: images
