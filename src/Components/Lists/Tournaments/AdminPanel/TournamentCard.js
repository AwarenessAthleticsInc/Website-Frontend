...
const TournamentCard = (props) => {
    ...
    const [tournament, setTournament] = useState({
        images: props.tournament ? props.tournament.images : [],
        city: props.tournament ? props.tournament.city : '',
        diamond: props.tournament ? props.tournament.diamond : '',
        province: props.tournament ? props.tournament.province : '',
        FullAddress: props.tournament ? props.tournament.address : '',
        ...
        startTime: props.tournament ? props.tournament.start.time : new Date().toTimeString(),
        startDate: props.tournament ? new Date(props.tournament.start.date).toDateString() : new Date().toDateString(),
        endTime: props.tournament ? props.tournament.end.time : new Date().toTimeString(),
        endDate: props.tournament ? new Date(props.tournament.end.date).toDateString() : new Date().toDateString(),
        minTeam: props.tournament ? props.tournament.teams.min : '',
        maxTeam: props.tournament ? props.tournament.teams.max : '',
        EntryDeadline: props.tournament ? new Date(props.tournament.EntryDeadline) : new Date().toDateString(),
        ...
        cancellationDate: props.tournament ? new Date(props.tournament.cancellationDate) : new Date().toDateString()
    });
    const conveners = users.filter((user) => {
    ...
    const save = () => {
        checkCompletion().then(() => {
            Axios.put('/api/dashboard/tournaments', {
                assets: {
    ...
    const update = () => {
        checkCompletion().then(() => {
            Axios.put(`/api/dashboard/tournaments/${props.tournament._id}`, {
                assets: {
                    poster: tournament.images[0],
                    images: tournament.images
                },
