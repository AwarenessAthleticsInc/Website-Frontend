...
const drawerWidth = window.innerWidth < 991 ? '65%' : '22vw';
...
export default function ConvenerWrapper(props) {
    ...
    React.useEffect(() => {
        ...
        if (user.account.roles === 'Convener') {
            return;
        }
        navigate('/');
    }, [user]);
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <ListItem key='Home' disablePadding>
                    <Link style={{ color: 'inherit', textDecoration: 'inherit', width: '100%' }} to={`/`}>
                        <ListItemButton>
                            <ListItemIcon>
                                <Home />
                            </ListItemIcon>
                ...
                <ListItem key='Overview' disablePadding>
                    <Link style={{ color: 'inherit', textDecoration: 'inherit', width: '100%' }} to={`/conveners`}>
                        <ListItemButton>
                            <ListItemIcon>
                                <RemoveRedEyeIcon />
                            </ListItemIcon>
