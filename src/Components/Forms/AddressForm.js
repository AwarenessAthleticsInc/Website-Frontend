...
const AddressForm = (props) => {
    ...
    return <Grid container spacing={2}>
        <Grid item xs={12} sm={6}>
            <TextField fullWidth onChange={props.onChange} id='firstName' label="First Name"
            required />
        </Grid>
        <Grid item xs={12} sm={6}>
            <TextField fullWidth onChange={props.onChange} id='lastName' label="Last Name"
                required />
        </Grid>
        <Grid item xs={12} sm={12}>
            <TextField fullWidth onChange={props.onChange} type='email' id='email' label="Email Address"
                required />
        </Grid>
        <Grid item xs={12} sm={8}>
            <TextField fullWidth onChange={props.onChange} id='street' label="Street"
                required />
        </Grid>
        <Grid item xs={12} sm={4}>
            <TextField fullWidth onChange={props.onChange} id='unit' label="Unit #" />
        </Grid>
        <Grid item xs={12} sm={6}>
            <TextField fullWidth onChange={props.onChange} id='city' label="City"
                required />
        </Grid>
        <Grid item xs={12} sm={6}>
            <TextField
        ...
        <Grid item xs={12} sm={5}>
            <TextField fullWidth onChange={props.onChange} id='postal' label="Postal/Zip Code"
                required />
        </Grid>
    </Grid>
