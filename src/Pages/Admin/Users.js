...
import UserList from '../../Components/Lists/Users/UserList';
import SetUserPassword from '../../Components/Lists/Users/setUserPassword';
...
const Users = (props) => {
    ...
    const deleteUsers = () => {
        ...
        Axios.delete('/api/dashboard/users', {
            data: {
                selected
            }
