import TournamentList from "../../Components/Lists/Tournaments/TournamenList";
import { useState } from "react";
import Snackbar from '@mui/material/Snackbar';
import EventFilters from "../../Components/Lists/Tournaments/EventFilters";
...
const Tournaments = (props) => {
    ...
    return <Box sx={{ width: { xs: '98%', md: '90%' }, m: { xs: '2rem 1%', md: '2rem 5%' } }}>
        <EventFilters key='2' tournaments={filteredList ? filteredList : tournaments} onFilter={filter} onClear={() => { closeSnack() }} />
        <TournamentList
            tournaments={filteredList ? filteredList : tournaments}
